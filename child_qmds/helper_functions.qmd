...
read_raw <- function(i,
    ...
    if (!file.exists(path_h5)) {
        ...
        if (counts$n_cells_post_filter >= min_n_cells) {
            ...
            opt_res <-
                rrrSingleCellUtils::optimize_silhouette(sobj, summary_plot = FALSE) %>%
    ...
    parallel::mclapply(
        ...
        function(cutoff) {
            ...
            scanBit::get_snp_tree(
                ...
                ref_fasta =
                    "/home/gdrobertslab/lab/GenRef/10x-hg38/fasta/genome.fa",
                min_depth = min_read_depth,
                sbatch_base = "downsample_cells",
                min_snvs_per_cluster = min_snvs_per_cluster,
                n_bootstraps = 10000,
                max_prop_missing_at_site = 0.9,
                cleanup = cleanup,
                other_sbatch_options = "--time=12:00:00\nml miniforge3"
            )
        }
    )
}
